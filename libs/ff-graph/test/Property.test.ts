...
describe("Property", function() {
    ...
    it("construction/preset", function() {
        const ins = comp0.ins;
    ...
    it("linking/conversion", function() {
