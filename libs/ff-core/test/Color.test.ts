...
describe("Color", function() {
    ...
    it("fromString - static constructor from 6-digit hex string #4d7e09", function() {
    ...
    it("fromString - static constructor from rgba(143, 12, 117, 0.5)", function() {
    ...
    it("fromString - static constructor from hsl(180, 100, 50)", function() {
    ...
    it("fromString - static constructor from hsla(180, 100, 50, 0.5)", function() {
    ...
    it("constructor(r, g, b, a)", function() {
    ...
    it("getters red, green, blue, alpha", function() {
        const c = new Color(0.12, 0.45, 0.96, 0.1);
    ...
    it("setters red, green, blue, alpha", function() {
        const c = new Color();
        c.red = 0.12;
        c.green = 0.45;
        c.blue = 0.96;
    ...
    it("getters redByte, greenByte, blueByte, alphaByte", function() {
        const c = new Color(0.12, 0.45, 0.96, 0.1);
    ...
    it("setters redByte, greenByte, blueByte, alphaByte", function() {
        const c = new Color();
        c.redByte = 0.12 * 255;
    ...
    it("toString - returns a 6-digit hex color if alpha === 1", function() {
        const str = "#4b7fda";
        const c = Color.fromString(str);
        assert.strictEqual(c.toString(), str);
    });

    it("toString - returns an rgba color string if alpha < 1", function() {
        const str = "rgba(143, 12, 117, 0.2)";
        const c = Color.fromString(str);
        assert.strictEqual(c.toString(), str);
    });

    it("setHSL - hsl to rgb conversion, without alpha", function() {
        const c = new Color();
        c.setHSL(240, 1, 0.5);
        assert.approximately(c.x, 0, eps, "red");
    ...
    it("setHSL - hsl to rgb conversion, with alpha", function() {
        const c = new Color();
    ...
    it("toHSL - rgb to hsl conversion (a)", function() {
    ...
    it("toHSL - rgb to hsl conversion (b)", function() {
