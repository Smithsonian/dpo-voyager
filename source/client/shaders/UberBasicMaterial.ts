...
import { Vector3, Vector4, Color, Side, UniformsUtils, ShaderLib, NoBlending, DoubleSide, 
    AdditiveBlending, FrontSide, Texture, ObjectSpaceNormalMap, 
    MeshBasicMaterial,
...
export interface IUberBasicShaderProps extends MeshBasicMaterialParameters
{

}

export default class UberMaterial extends MeshBasicMaterial
{
    ...
    constructor(params?: IUberBasicShaderProps)
    {
        super();

        this.type = "UberBasicMaterial";
