...
export default class MainMenu extends DocumentView
{
    ...
    protected render()
    {
        ...
        ${tourButtonVisible ? html`<ff-button aria-pressed=${toursActive} icon="globe" title=${language.getLocalizedString("Interactive Tours")}
            ?selected=${toursActive} @click=${this.onToggleTours}></ff-button>` : null}
        ${readerButtonVisible ? html`<ff-button aria-pressed=${readerActive} icon="article" title=${language.getLocalizedString("Read more...")}
        ...
        <ff-button icon="share" aria-pressed=${this.shareButtonSelected} title=${language.getLocalizedString("Share Experience")}
        ...
        ${toolButtonVisible ? html`<ff-button aria-pressed=${toolsActive} icon="tools" title=${language.getLocalizedString("Tools and Settings")}
