...
{  
    ...
    protected static readonly logoSm = html`<div class="sv-logo-sm"><object data="images/logo-sm.svg" type="image/svg+xml" alt="Logo"></div>
            ${Logo.defaultSmall}
        </object></div>`;
    protected static readonly logoFull = html`<div class="sv-logo-full"><object style="height: 100%; width:100%" data="images/logo-full.svg" type="image/svg+xml" alt="Logo">
            ${Logo.defaultFull}
        </object></div>`;
    ...
    protected render()
    {
        return html`<div class="sv-short">${Logo.logoSm}</div><div class="sv-full">${Logo.logoFull}</div>`;
    }
}