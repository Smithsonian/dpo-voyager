...
Icon.add("compass", html`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 8C119.033 8 8 119.033 8 256s111.033 248 248 248 248-111.033 248-248S392.967 8 256 8zm0 448c-110.532 0-200-89.451-200-200 0-110.532 89.451-200 200-200 110.532 0 200 89.451 200 200 0 110.532-89.451 200-200 200zm91.326-312.131l-122.665 61.333c-5.662 2.831-10.063 7.232-12.894 12.894l-61.333 122.665c-7.128 14.257 9.472 30.857 23.729 23.729l122.665-61.333c5.662-2.831 10.063-7.232 12.894-12.894l61.333-122.665c7.128-14.257-9.472-30.857-23.729-23.729zM256 283.415c-15.119 0-27.415-12.296-27.415-27.415s12.296-27.415 27.415-27.415 27.415 12.296 27.415 27.415-12.296 27.415-27.415 27.415z"/></svg>`);
...
Icon.add("record", html`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><path d="M50 10A40 40 0 1 0 50 90A40 40 0 1 0 50 10Z M50 18A32 32 0 1 1 50 82A32 32 0 1 1 50 18Z M50 30A20 20 0 1 1 50 70A20 20 0 1 1 50 30Z" fill-rule="evenodd" /></svg>`);
