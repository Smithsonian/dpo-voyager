 ...
 */
export default class NSpotLightNode extends NLightNode
{
    static readonly type: string = "NSpotLightNode";

    protected light: CSpotLight = null;

    createComponents()
    {
        super.createComponents();
        this.light = this.createComponent(CSpotLight);
        this.name = "SpotLight";
    }
