 ...
 */
export default class NDirectionalLightNode extends NLightNode
{
    static readonly type: string = "NDirectionalLightNode";

    protected light: CDirectionalLight = null;

    createComponents()
    {
        super.createComponents();
        this.light = this.createComponent(CDirectionalLight);
