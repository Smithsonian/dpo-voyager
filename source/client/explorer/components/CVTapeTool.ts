...
export default class CVTapeTool extends CObject3D
{
    ...
    ins = this.addInputs<CObject3D, typeof CVTapeTool.tapeIns>(CVTapeTool.tapeIns);
    outs = this.addOutputs<CObject3D, typeof CVTapeTool.tapeOuts>(CVTapeTool.tapeOuts);
