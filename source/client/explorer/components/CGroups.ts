...
export interface IGroupsChangeEvent extends IComponentChangeEvent<CGroups>
{
    what: "add" | "remove";
    group: IGroup;
}
...
export default class CGroups extends CCollection<IGroup>
{
    static readonly type: string = "CGroups";

    protected rootCollection: CGroups = null;
