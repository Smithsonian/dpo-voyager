...
export default class CPresentationData extends Component
{
    static readonly type: string = "CPresentationData";
    ...
    protected get setupNode() {
        return this.graph.nodes.get(NPresentationSetup);
    }
    protected get sceneNode() {
        return this.graph.nodes.get(NPresentationScene);
    }
    ...
    toData(writeReferences: boolean = false): IPresentation
    {
        ...
        data.info = {
            type: CPresentationData.mimeType,
