...
import JSONWriter from "../../core/writers/JSONWriter";
import DocumentWriter, { INodeComponents } from "../../core/writers/DocumentWriter";
...
export default class CVAssetWriter extends Component implements IAssetService
{
    ...
    readonly documentWriter: DocumentWriter;
