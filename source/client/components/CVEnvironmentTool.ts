    ...
    protected render()
    {
        ...
        return html`<div class="sv-section"><ff-button class="sv-section-lead" title=${language.getLocalizedString("Close Tool")} @click=${this.onClose} transparent icon="close"></ff-button>
            <div class="sv-tool-controls">
                ...
                <sv-property-color title="Background Color 1" .compact=${true} class="sv-nogap" .property=${background.ins.color0} name=" "></sv-property-color>
                ${!isSolid ? html`<sv-property-color title="Background Color 2" .compact=${true} class="sv-nogap" .property=${background.ins.color1} name=" "></sv-property-color>` : null}
                ...
                <sv-property-color title="Grid Color" .compact=${true} class="sv-nogap" .property=${grid.ins.color} name=" "></sv-property-color>
                ...
                <sv-property-color title="Floor Color" .compact=${true} class="sv-nogap" .property=${floor.ins.color} name=" "></sv-property-color>
