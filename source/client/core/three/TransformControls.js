...
THREE.TransformControls = function () {
    ...
    this.pointerHover = function (pointer) {
        if (this.object === undefined || this.dragging === true || (pointer.button !== -1 && pointer.button !== 0)) return;
    ...
    this.pointerDown = function (pointer) {
        ...
        if ((pointer.button === 0 || pointer.button === -1) && this.axis !== null) {
    ...
    this.pointerMove = function (pointer) {
        ...
        if (object === undefined || axis === null || this.dragging === false || (pointer.button !== -1 && pointer.button !== 0)) return;
    ...
    this.pointerUp = function (pointer) {
        ...
        if (pointer.button !== -1 && pointer.button !== 0) return;
        ...
        if (pointer.button === -1) this.axis = null;
    ...
    this.onPointer = function(event)
    {
        ...
        this.camera = event.viewport.camera;
...
THREE.TransformControlsGizmo = function () {
    ...
    this.updateMatrixWorld = function () {
        ...
        var isPerspective = this.camera.isPerspectiveCamera;
        var eyeDistance = isPerspective
        ...
        for (var i = 0; i < handles.length; i++) {
            ...
            handle.scale.set(1, 1, 1).multiplyScalar(eyeDistance * this.size / 5);
...
module.exports.TransformControls = THREE.TransformControls;
