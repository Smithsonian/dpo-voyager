 ...
 */
 ...
 export default class Navbar extends LitElement
 {
  ...
  return html`<nav>
    <div class="brand"> <a style="display:block;color:white;text-decoration:none;font-weight:bold" href="/"><img style="height:100%" scr="/images/logo-planete.png" alt="logo planete"> E-Corpus</a> </div>
